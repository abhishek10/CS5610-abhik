...
<asp:Content ID="Content2" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript" src="../javascript/project/Project_select_category.js"></script>
    <script type="text/javascript" src="../javascript/project/Project_search_restaurant.js"></script>
    <script type="text/javascript" src="../javascript/project/Project_auth_key.js"></script>
    <script type="text/javascript" src="../javascript/project/Project_dropdown.js"></script>
...
<asp:Content ID="Content1" ContentPlaceHolderID="data" Runat="Server">
    ...
    <div class="aspNetHidden">
        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTE0OTQ0MzQ5NjBkZDVMufKG0gy6OQkVoNSp73tgjZ1GYTh9KXxA8hIxBbLJ" />
    </div>
    ...
    <div id="searchBox">
        <div id="topSearchBox">
            ...
            <div id="textBoxes">    
                <input type = "text" size = "25" id="locationName" placeholder="Enter Location (like city/State/... etc)" autocomplete = "on" name = "location" value="Boston" onkeypress="return enterKey(event)" />
        ...
        <div id="data" class="data1 height">
            <p id="search">SEARCH RESULTS <br/>Click on 'Booking' link to book tickets</p>
        <div id="nav">
