...
<div>
 <h2>About the Experiment</h2> 
  <p>Calling external web API to get location of event</p>
</div>
<hr />
<div>
     <h2>Demo</h2>
    Event Name - Mamma Mia <br><br>
    <input type="button" onclick="get_location()" value="Get Location" /> <br>
</div>
<hr />
    <div>
       <h2>Code Snippet</h2> 
...
function get_location() {
    ...
    <div>
       ...
       <a href="../../fileview/Default.aspx?~/experiments/WEBAPI/Location.aspx" target="_blank">View Source</a><br>
