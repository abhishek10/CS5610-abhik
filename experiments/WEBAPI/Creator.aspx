...
<div>
 <h2>About the Experiment</h2> 
  <p>Calling external web API to get Creator of the event</p>
</div>
<hr />
<div>
     <h2>Demo</h2>
    Event Name - Mamma Mia <br><br>
    <input type="button" onclick="get_creator()" value="Who is Organizing" /> <br>
</div>
<hr />
    <div>
       <h2>Code Snippet</h2> 
...
function get_location() {
    ...
    alert(oData.events.event[0].creator);
    });
}
       </p>
    </div>
    ...
    <div>
       ...
       <a href="../../fileview/Default.aspx?~/experiments/WEBAPI/Creator.aspx" target="_blank">View Source</a><br>
